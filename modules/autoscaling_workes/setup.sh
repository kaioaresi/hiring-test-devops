...
basic_itens(){
  ...
  if `$disable_swap`; then
    ...
    logger "######## Add ao master!"
    kubeadm join 172.31.95.126:6443 --token gdmtkj.izvl7om4vjvngq59 --discovery-token-ca-cert-hash sha256:427071389d46cf13d2555febdab37c7a137e27a589d23c5aa07dc4a85295830a
    logger "######## Done Add ao master!"
